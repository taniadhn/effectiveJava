...
//Enumlari Constantler yerine kullanmak

//Enumları ne zaman kullanmalıyım: Benim değişkenleriminin sabit olduğu. değerlerini bildiğim şeylerin ENUM kullanmak yararlı olacak
...
public class TestDrive {
    ...
    // Enum dediğimiz şey Singletonların genelleştirilmiş hali
